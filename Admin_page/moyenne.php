...
<body>
  <center>
    ...
    <H2><b><?php date_default_timezone_set('UTC'); echo date('<em>l F Y h:i A<em>');?></b></H2><br/><br/>
    <a href="index.php">ACCUEIL</a>
    <!-- <hr class="trait"> -->
    <br/><br/><br/><br/><br/><br/>
    <form method="POST" action="bulletin.php">
      <span class="search"><input type="search" name="matricule" > <span class="glyphicon glyphicon-search"></span> </span>
